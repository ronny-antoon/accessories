...
SwitchButtonAccessory::SwitchButtonAccessory(gpio_num_t button_pin)
{
    ...
    // buttonCallback
    iot_button_register_cb(handle, BUTTON_SINGLE_CLICK, [](void *button_handle, void *this_ptr)
                           {
        ESP_LOGI(__FILENAME__, "call %s", __FUNCTION__);
        ...
        switchButtonAccessory->reportAttributes(); }, this);

    iot_button_register_cb(handle, BUTTON_LONG_PRESS_START, [](void *button_handle, void *this_ptr)
                           {
        ESP_LOGI(__FILENAME__, "call %s", __FUNCTION__);
    ...
    iot_button_register_cb(handle, BUTTON_DOUBLE_CLICK, [](void *button_handle, void *this_ptr)
                           {
        ESP_LOGI(__FILENAME__, "call %s", __FUNCTION__);
...
void SwitchButtonAccessory::identifyYourSelf()
{
    ESP_LOGI(__FILENAME__, "call %s", __FUNCTION__);
}
