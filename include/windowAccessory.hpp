...
public:
     ...
     *
     */
    WindowAccessory(gpio_num_t button_down_pin, gpio_num_t button_up_pin, gpio_num_t motor_up_pin, gpio_num_t motor_down_pin, uint32_t time_to_open, uint32_t time_to_close);
